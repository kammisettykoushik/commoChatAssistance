...
import { FaPaperPlane, FaFile, FaSearch, FaUpload, FaDownload, FaTimes } from "react-icons/fa";
            ...
            {contactsData.filter(contact => contact.name.toLowerCase().includes(searchTerm.toLowerCase())).map((contact) => (
              ...
              >
                ...
                <div className="d-flex flex-column">
                  ...
                  <span className={`text-${contact.status === "Online" ? "success" : "muted"}`} style={{ fontSize: "12px" }}>
