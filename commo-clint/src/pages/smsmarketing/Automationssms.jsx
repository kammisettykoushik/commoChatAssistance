...
const Automationssms = () => {
    ...
    return (
        <div style={{ padding: "20px", backgroundColor: '#EAF6FE' }}>
            <div style={{ marginBottom: "20px" }}>
                <label htmlFor="working-hours" style={{ marginLeft: 10 }}>
                    <b>Current Working Hours:</b>
                </label>
                <div style={{ position: 'relative', display: 'inline-block' }}>
                    <button onClick={toggleDropdown} style={{ backgroundColor: '#0070C0', padding: 5, color: 'white', border: 'none', borderRadius: 5, marginLeft: 10 }}>Set Working Hours</button>
                    {isDropdownVisible && (
                        <div
                            style={{
                                position: 'absolute',
